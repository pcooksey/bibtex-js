...
function BibtexDisplay() {
  ...
  this.fixValue = function (value) {
    ...
    while(index > -1) {
      var nextValue = value.indexOf("}");
      var key = value.substring(index, value.indexOf("}"));
      value = value.replace(key,this.latex_to_unicode[key]);
      console.log(value);
    ...
    */
    if(value.indexOf("\\")>-1) {
      for(var key in unicode_to_latex) {
        value = value.replace(unicode_to_latex[key], key);
      }
    }
